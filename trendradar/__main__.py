...
from trendradar.utils.time import DEFAULT_TIMEZONE, get_configured_time, is_within_days, calculate_days_old
...
def _save_doctor_report(
    ...
    report = {
        "version": __version__,
        "generated_at": get_configured_time(DEFAULT_TIMEZONE).isoformat(),
