...
from trendradar.utils.time import DEFAULT_TIMEZONE, format_iso_time_friendly, convert_time_for_display, get_configured_time
...
def split_content_into_batches(
    ...
    now = get_time_func() if get_time_func else get_configured_time(DEFAULT_TIMEZONE)
