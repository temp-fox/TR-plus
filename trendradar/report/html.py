...
from trendradar.utils.time import DEFAULT_TIMEZONE, convert_time_for_display, format_iso_time_friendly, get_configured_time
    ...
    def render_standalone_html(data: Optional[Dict]) -> str:
        ...
        for feed in rss_feeds:
            ...
            for j, item in enumerate(items, 1):
                ...
                # 时间显示（统一转换为北京时间）
                if published_at:
                    time_display = format_iso_time_friendly(published_at, DEFAULT_TIMEZONE)
    ...
    html += """
        ...
        <script>
            ...
            function beijingTimestamp() {
                ...
                return {
                    compact: `${parts.year}${parts.month}${parts.day}_${parts.hour}${parts.minute}`,
            ...
            async function saveAsImage(e) {
                ...
                try {
                    ...
                    const filename = `TrendRadar_热点新闻分析_${ts.compact}.png`;
            ...
            async function saveAsMultipleImages(e) {
                ...
                try {
                    ...
                    // 下载所有图片
                    const ts = beijingTimestamp();
                    const baseFilename = `TrendRadar_热点新闻分析_${ts.compact}`;
