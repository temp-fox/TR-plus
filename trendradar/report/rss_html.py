...
from trendradar.utils.time import DEFAULT_TIMEZONE, format_iso_time_friendly, get_configured_time
    ...
    *,
    ...
    for feed_id, items in feeds_map.items():
        ...
        for item in items:
            ...
            if published_at:
                published_display = format_iso_time_friendly(published_at, DEFAULT_TIMEZONE)
                html += f'<span class="rss-time">{html_escape(published_display)}</span>'
        ...
        <script>
            ...
            async function saveAsImage() {
                ...
                try {
                    ...
                    const filename = `TrendRadar_RSS订阅_${beijingTimestamp()}.png`;
